					...
					return (
						...
						(t.prototype._writeImpl = function (t) {
							...
							for (
								...
								(e = this.parser.readToken()) && !(r = f.isScript(e)) && !(n = f.isStyle(e));
									...
									if (!/^noscript$/i.test(s.tagName)) {
										...
										n.push(u.replace(/(\/?>)/, " " + d + "id=" + c + " $1")),
											s.attrs.id !== m &&
												s.attrs.id !== y &&
												o.push(
													"atomicTag" === s.type ? "" : "<" + s.tagName + " " + d + "proxyof=" + c + (s.unary ? " />" : ">")
												);
									}
									...
									(t.prototype._peekTokenImpl = function () {
										for (var t in h)
											if (h.hasOwnProperty(t) && h[t].test(this.stream)) {
												...
												if (e)
													return "startTag" === e.type && /script|style/i.test(e.tagName)
														? null
										...
										(t.formatTag = function (t) {
											...
											for (var n in t.attrs)
												if (t.attrs.hasOwnProperty(n)) {
													r += " " + n;
													var i = t.attrs[n];
													("undefined" != typeof t.booleanAttrs && "undefined" != typeof t.booleanAttrs[n]) ||
